...
export default function FunctionsPage() {
  return (
    <>
      <PageHero label="Private functions" title="Host your gathering among the vines" tone="forest">
        <p>
      ...
      <section className="py-16 md:py-24">
        <div className="mx-auto max-w-7xl px-5 md:px-8 grid lg:grid-cols-2 gap-14">
          <div className="space-y-8 prose-harman text-stone">
            <div>
              <h2 className="font-display text-3xl text-charcoal">Weddings & celebrations</h2>
              <p className="mt-3">
            ...
            <div>
              <h2 className="font-display text-3xl text-charcoal">Corporate & private</h2>
              <p className="mt-3">
            ...
            <div>
              <h2 className="font-display text-3xl text-charcoal">Food & wine</h2>
              <p className="mt-3">
