...
export default function NotFound() {
  return (
    <div className="min-h-[70svh] flex items-center bg-cream">
      <div className="mx-auto max-w-2xl px-5 md:px-8 py-24">
        <p className="label-micro text-stone">404</p>
        ...
        <p className="mt-8">
          <Link href="/visit" className="label-micro text-wine no-underline hover:underline">
            Plan a visit →
          </Link>
        </p>
      </div>
